...
const Orders = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {(orders.length===0||orders2.length===0)&&<EmptyState text='Orders Empty'/>}
      ...
      <FAB
        icon="cart" color='white' label='Order Now'
        style={{position: 'absolute',margin: 16, fontWeight:600,right: 10,bottom: 10,backgroundColor:Colors.green}}
