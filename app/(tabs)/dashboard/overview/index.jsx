    ...
    <View style={styles.container}>
      ...
      <View style={{padding:20,flex:1 }}>
        ...
        <View style={{flexDirection:'row', gap:14, marginTop:20}}>
          <View style={{flexDirection:'row',flex: 1,borderColor:Colors.border,borderRadius:12, borderWidth:1,padding:20,justifyContent:'space-between'}}> 
            <View style={{flexDirection:'column', gap:8}}>
              <Text style={{color:Colors.grey, fontSize:12}}>My Orders</Text>
              <Text style={{fontSize:20, fontWeight:600}}>12,000</Text>
            </View>
            <View style={{borderWidth:1,padding:8,alignSelf:'center',backgroundColor:'rgba(26, 184, 84,0.15)',borderColor:Colors.border, borderRadius:8, alignContent:'center', justifyContent:'center'}}>
              <MaterialCommunityIcons name="receipt-text-edit" size={18} color={Colors.green} />
            </View>
          </View>
          <View style={{flexDirection:'row',flex: 1,borderColor:Colors.border,borderRadius:12, borderWidth:1,padding:20,justifyContent:'space-between'}}> 
            <View style={{flexDirection:'column', gap:8}}>
              <Text style={{color:Colors.grey, fontSize:12}}>Transactions</Text>
              <Text style={{fontSize:20, fontWeight:600}}>850</Text>
            </View>
            <View style={{borderWidth:1,padding:8,alignSelf:'center',backgroundColor:'rgba(26, 184, 84,0.15)',borderColor:Colors.border, borderRadius:8, alignContent:'center', justifyContent:'center'}}>
              <MaterialCommunityIcons name="compare-horizontal" size={18} color={Colors.green} />
            </View>
          </View>
        </View>
            ...
            {[1,2,3,4,5,6,7,8,9].map(a => (
              <View key={a} style={{flexDirection:'row', gap:10, marginTop:12, borderWidth:1, padding:12,borderColor:Colors.border,borderRadius:24,alignItems: 'center',}}>
                ...
                <View style={{ flex: 1, gap: 6 }}>
                  <Text style={{fontSize:16,fontWeight:600}} numberOfLines={1} ellipsizeMode="tail">Open Sea restaurant</Text>
                ...
                <View style={{alignItems: 'flex-end',gap: 6}}>
                  ...
                  <Text style={{color:Colors.green,fontWeight:600}}>Successful</Text>
                </View>
              </View>
            ))}
        </ScrollView>
